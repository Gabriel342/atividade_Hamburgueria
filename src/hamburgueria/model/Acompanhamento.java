...
public class Acompanhamento {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.TABLE, generator="gerador_idA")
	private int id;
	...
	@OneToMany(mappedBy="acompanhamentos")
	...
	public Acompanhamento(int id, String nome, double valor, String ingredientesComponentes, List<Combo> combos) {
		super();
		this.id = id;
		this.nome = nome;
		this.valor = valor;
